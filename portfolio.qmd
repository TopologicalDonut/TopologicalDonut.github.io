...
The pipeline scrapes all the files and zips that contain data on price indices, validates the data quality, and stores the data into a local DuckDB database.
