...
[Link to report {{< fa link >}}](files/DST_Report.pdf){.btn .btn-outline-primary} [Source code {{< fa brands github >}}](https://github.com/TopologicalDonut/Vancouver-Crime-Analysis){.btn .btn-outline-primary}
