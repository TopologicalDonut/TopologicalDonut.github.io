...
Our estimates confirm the intuition from the graphs. Both estimates are close to 0,[^3] and the confidence intervals suggest that DST has little to no meaningful effect on crime rates in Vancouver.
